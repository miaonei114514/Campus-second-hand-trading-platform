...
(0, jquery_1.default)("#topBar").wrapInner((0, components_1.buildTopBar)("index", true));
(0, jquery_1.default)("#searchBar").wrapInner((0, components_1.buildSearch)("searchHover"));
...
(0, jquery_1.default)(window).on("scroll", () => {
    let h = (0, jquery_1.default)(window).height();
...
function buildShopList() {
    jquery_1.default.get("/goods-list", { offset: offset, amount: 24 }, (res) => {
        if (res.status == "error") {
            alert(res.message);
            loading = false;
        }
...
},{"../scripts/components":4,"../scripts/types":5,"jquery":2}],4:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"cropperjs":1,"jquery":2}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.UserInfo = exports.TopicInfo = exports.OrdersInfo = exports.GoodsListResult = exports.GoodsInfo = exports.ImgInfo = exports.Result = void 0;
class Result {
    status;
    code;
    obj;
