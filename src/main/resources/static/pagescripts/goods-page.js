...
$("#topBar").wrapInner((0, components_1.buildTopBar)());
let logged = null;
let goodId;
...
function publishTopic(topic) {
    ...
    $.post(`/goods-topics/${goodId}`, { target: goodId, content: topic }, (res) => {
        if (res.status == "error")
...
function profile(id) {
    $.get(`/usercontext/${id}`, (res) => {
        if (res.status == "error")
            window.alert(res.message);
        else
            window.location.href = `/profile/${res.obj.uid}`;
    });
}
function deleteTopic(topicId) {
    (0, components_1.showConfirm)("确定要删除这条评论吗？", true, () => {
        ...
        $.post(`/delete-topic`, { topicId: topicId }, (res) => {
            if (res.status == "error")
                window.alert(res.message);
            else
                buildTopics(goodId);
...
function initGoods(id) {
    ...
    `);
        $.get(`/usercontext/${res.obj.owner}`, (r) => {
            if (r.status === "error") {
                alert(r.message);
                return;
            }
        ...
        $.get(`/goods-res/descriptions/${id}`, (r) => {
            if (r.status === "error")
                alert(r.message);
            else {
                let html = "";
...
function buildTopics(id) {
    ...
    `);
    (0, components_1.relativeWords)($("#edit-topic"), $("#words"), 500);
    $.get("/usercontext", (res) => {
        if (res.status == "error")
            return;
        logged = res.obj;
    ...
    $.get(`/goods-topics/${id}`, (res) => {
        if (res.status == "error")
            return;
        if (res.obj.length == 0)
            $("#topic-list").append(`<h5 class="margin-hor padding-box write-back">这里什么都没有...</h5>`);
        else
            $("#topic-list").append(buildTopic(res.obj));
    });
}
function buildTopic(list) {
    ...
    for (let topic of list) {
      ...
      `;
        $.get(`/usercontext/${topic.publisher}`, (res) => {
...
},{"../scripts/components":4}],4:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
exports.putFile = exports.relativeWords = exports.buildGoodsList = exports.showCropper = exports.showConfirm = exports.buildGoods = exports.buildScrollImg = exports.buildTopBar = exports.buildSearch = void 0;
...
function showCropper(img, callback) {
    (0, jquery_1.default)('body').append(`
  ...
  `);
    (0, jquery_1.default)('.cover').show();
    let cropper = new cropperjs_1.default((0, jquery_1.default)("#img")[0], {
        aspectRatio: 1,
        crop(event) {
            console.log(event);
